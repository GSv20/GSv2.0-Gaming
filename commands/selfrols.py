...
class role(commands.Cog):
    ...
    async def selfrols(self, ctx, channel: Option(discord.TextChannel, "Der Channel in dem das Menü gesendet werden soll", required=True)):
        gsv = discord.Color.dark_gold()
        embed = discord.Embed(title="Plattformen", description='Wähle deine Plattform bzw. Plattformen\n'
                                                                '- Damit die anderen User bescheid wissen wie sie mit dir spielen können', color=gsv)
        ...
        embed2.set_footer(text='Powered by GSV ⚡', icon_url='https://cdn.discordapp.com/attachments/1073711669731151904/1218393384897740830/GSV_Logo_new_.png?ex=66078043&is=65f50b43&hm=522d323764bdb16890d3fb1f6d748de45d0f1fa51d3194485ef5804a25b25f25&')

        embed3 = discord.Embed(title="Sexualität", description='Freiwillige Angabe\n'
                                                                'Wenn du nicht willst musst du nicht', color=gsv)
        ...
        embed3.set_footer(text='Powered by GSV ⚡',
        ...
        embed4 = discord.Embed(title="Beziehungsstatus", description="Angaben sind Freiwillig", color=gsv)
        ...
        embed4.set_footer(text='Powered by GSV ⚡',
                          icon_url='https://cdn.discordapp.com/attachments/1073711669731151904/1218393384897740830/GSV_Logo_new_.png?ex=66078043&is=65f50b43&hm=522d323764bdb16890d3fb1f6d748de45d0f1fa51d3194485ef5804a25b25f25&')
        embed5 = discord.Embed(title="Alter", description="Gebe hier dein Alter an", color=gsv)
        ...
        embed5.set_footer(text='Powered by GSV ⚡',
                          icon_url='https://cdn.discordapp.com/attachments/1073711669731151904/1218393384897740830/GSV_Logo_new_.png?ex=66078043&is=65f50b43&hm=522d323764bdb16890d3fb1f6d748de45d0f1fa51d3194485ef5804a25b25f25&')

        embed6 = discord.Embed(title="Farbenauswahl", description="Wähle unten im menü die rolle aus", color=gsv)
        ...
        embed6.set_footer(text='Powered by GSV ⚡',
                          icon_url='https://cdn.discordapp.com/attachments/1073711669731151904/1218393384897740830/GSV_Logo_new_.png?ex=66078043&is=65f50b43&hm=522d323764bdb16890d3fb1f6d748de45d0f1fa51d3194485ef5804a25b25f25&')

        embed7 = (discord.Embed(title='Pingrollen', description='', colour=gsv))
        embed7.set_footer(text='Powered by GSV ⚡', icon_url='https://cdn.discordapp.com/attachments/1073711669731151904/1218393384897740830/GSV_Logo_new_.png?ex=66078043&is=65f50b43&hm=522d323764bdb16890d3fb1f6d748de45d0f1fa51d3194485ef5804a25b25f25&')

        channel_id = self.bot.get_channel(channel)
        await ctx.respond("Selfrols sind Aktiv", ephemeral=True)
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed, view=plattformen())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed2, view=geschlechtsauswahl())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed3, view=())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed4, view=())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed5, view=())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed6, view=())
        await asyncio.sleep(2)
        await ctx.channel.send(embed=embed7, view=())
